//! helix-cura-prime API — durable thin slice via helix_db.

use audit_log::AuditEvent;
use axum::extract::{Path, State};
use axum::routing::get;
use axum::{Json, Router};
use helix_db::CuraRepo;
...
fn domain_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/v1/care_cases/{id}", get(get_parent))
        .route(
...
async fn create_parent(
    ...
    state
        ...
        .append(AuditEvent {
            ...
            action: "care_case.create".into(),
            resource_type: "care_case".into(),
