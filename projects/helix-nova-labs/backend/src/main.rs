//! helix-nova-labs API — durable thin slice via helix_db.

use audit_log::AuditEvent;
use axum::extract::{Path, State};
use axum::routing::get;
use axum::{Json, Router};
use helix_db::NovaRepo;
...
fn domain_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/v1/experiments/{id}", get(get_parent))
        .route(
...
async fn create_parent(
    ...
    state
        ...
        .append(AuditEvent {
            ...
            action: "experiment.create".into(),
            resource_type: "experiment".into(),
