//! helix-synthbio API — durable thin slice via helix_db.

use audit_log::AuditEvent;
use axum::extract::{Path, State};
use axum::routing::get;
use axum::{Json, Router};
use helix_db::SynthbioRepo;
...
fn domain_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/v1/designs/{id}", get(get_parent))
        .route(
            "/v1/designs/{id}/sims",
...
async fn create_parent(
    ...
    state
        ...
        .append(AuditEvent {
            ...
            action: "design.create".into(),
            resource_type: "design".into(),
