...
**Order:** 12 · **Tier:** frontier

Autonomous legal & regulatory intelligence
...
- Events: NATS JetStream subjects `helix.helix-lex-prime.*`
- Objects: MinIO bucket `helix-helix-lex-prime`

## Local development

```bash
# from monorepo root
cargo run -p helix_lex_prime_api
cd projects/helix-lex-prime/web && pnpm dev
```
