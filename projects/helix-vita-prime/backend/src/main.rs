//! helix-vita-prime API — durable thin slice via helix_db.

use audit_log::AuditEvent;
use axum::extract::{Path, State};
use axum::routing::get;
use axum::{Json, Router};
use helix_db::VitaRepo;
...
fn domain_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/v1/studies/{id}", get(get_parent))
        .route(
...
async fn create_parent(
    ...
    state
        ...
        .append(AuditEvent {
            ...
            action: "study.create".into(),
            resource_type: "study".into(),
