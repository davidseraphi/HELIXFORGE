...
**Order:** 18 · **Tier:** frontier

Precision medicine & longevity research platform
...
- Events: NATS JetStream subjects `helix.helix-vita-prime.*`
- Objects: MinIO bucket `helix-helix-vita-prime`

## Local development

```bash
# from monorepo root
cargo run -p helix_vita_prime_api
cd projects/helix-vita-prime/web && pnpm dev
```
